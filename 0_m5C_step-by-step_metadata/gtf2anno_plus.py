...
if __name__ == "__main__":
	...
	for trans_id in dictInfo.keys():
		...
		print "\t".join([ident,trans_id,dictInfo[trans_id]['chr'],dictInfo[trans_id]['dir'],str(txStart),str(txEnd),str(cdsStart),str(cdsEnd),str(exonCount),exonStarts,exonEnds,".",dictInfo[trans_id]['gene_id'],'.','.','.'])
